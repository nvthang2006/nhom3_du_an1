...
class CheckinController extends BaseController
{
    public function list()
    {
        ...
        $assignId = $_GET['assign_id'] ?? 0;
        $m = new CheckinRecord();
        $records = $m->listByAssign((int)$assignId);
        $this->view('hdv/checkin/list', ['records' => $records]);
    }
